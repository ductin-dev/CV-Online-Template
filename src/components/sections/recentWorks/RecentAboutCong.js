            ...
            <div className="box-item">
              <div className="image">
                <a href="images/twork1.jpg" className="has-popup-image">
                  <img src="images/cong_image/SATDEVELOP Team.jpg" alt="" />
                  <span className="info">
              ...
              <div className="desc">
                ...
                <div className="category">knowledge exchange blog</div>
              </div>
            </div>
          </div>
          {/* work item video */}
            ...
            <div className="box-item">
              <div className="image">
                <a href="#gallery-2" className="has-popup-gallery">
                  <img src="images/cong_image/capstone project.jpg" alt="" />
                  <span className="info">
                    <span className="ion ion-images" />
                  </span>{" "}
              ...
              <div className="desc">
                ...
                <div className="category">Deverlop ECS architecture for simulation framework</div>
              </div>
            </div>
          </div>
          <div className="clear" />
...
export default RecentAboutCong;
