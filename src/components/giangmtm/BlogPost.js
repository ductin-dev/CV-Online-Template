...
const BlogPostNew = () => {
  return (
    <div
      className={`blog blog-post ${ActiveSection("blog-post-giang")}`}
      id="blog-card"
    >
              ...
              <div className="post-box">
                ...
                <div className="blog-detail">
                  ...
                  <span className="cat-links">
                    <a href="#">SEO</a>, <a href="#">Recruit</a>
                  </span>
                  <span className="byline">
                    {" "}
                    by{" "}
                    <span className="author">
                      <a href="#">Mai Thi My Giang</a>
                    </span>
                  </span>
                </div>
                {/* blog image */}
                    ...
                    <div className="comment">
                      ...
                      <div className="comment-desc desc">
                        <div className="comment-name name">
                          <span className="comment-author">Duc Tin</span>
